...
import theLastLightMod.events.IdentityCrisisEvent;
import theLastLightMod.potions.PlaceholderPotion;
import theLastLightMod.relics.BetterPotionBelt;
import theLastLightMod.relics.BottledPlaceholderRelic;
...
import theLastLightMod.util.IDCheckDontTouchPls;
import theLastLightMod.util.TextureLoader;
import theLastLightMod.variables.DefaultCustomVariable;
import theLastLightMod.variables.DefaultSecondMagicNumber;
...
public class DefaultMod implements
    ...
    private static final String MODNAME = "LastLight Mod";
    private static final String AUTHOR = "Gremious, LastLight"; // And pretty soon - You!
    private static final String DESCRIPTION = "LastLight's first attempt at modding";
    ...
    private static final String ATTACK_DEFAULT_GRAY = "theLastLightModResources/images/512/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY = "theLastLightModResources/images/512/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY = "theLastLightModResources/images/512/bg_power_default_gray.png";
    
    private static final String ENERGY_ORB_DEFAULT_GRAY = "theLastLightModResources/images/512/card_default_gray_orb.png";
    private static final String CARD_ENERGY_ORB = "theLastLightModResources/images/512/card_small_orb.png";
    
    private static final String ATTACK_DEFAULT_GRAY_PORTRAIT = "theLastLightModResources/images/1024/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY_PORTRAIT = "theLastLightModResources/images/1024/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY_PORTRAIT = "theLastLightModResources/images/1024/bg_power_default_gray.png";
    private static final String ENERGY_ORB_DEFAULT_GRAY_PORTRAIT = "theLastLightModResources/images/1024/card_default_gray_orb.png";
    
    // Character assets
    private static final String THE_DEFAULT_BUTTON = "theLastLightModResources/images/charSelect/DefaultCharacterButton.png";
    private static final String THE_DEFAULT_PORTRAIT = "theLastLightModResources/images/charSelect/DefaultCharacterPortraitBG.png";
    public static final String THE_DEFAULT_SHOULDER_1 = "theLastLightModResources/images/char/defaultCharacter/shoulder.png";
    public static final String THE_DEFAULT_SHOULDER_2 = "theLastLightModResources/images/char/defaultCharacter/shoulder2.png";
    public static final String THE_DEFAULT_CORPSE = "theLastLightModResources/images/char/defaultCharacter/corpse.png";
    
    //Mod Badge - A small icon that appears in the mod settings menu next to your mod.
    public static final String BADGE_IMAGE = "theLastLightModResources/images/Badge.png";
    
    // Atlas and JSON files for the Animations
    public static final String THE_DEFAULT_SKELETON_ATLAS = "theLastLightModResources/images/char/defaultCharacter/skeleton.atlas";
    public static final String THE_DEFAULT_SKELETON_JSON = "theLastLightModResources/images/char/defaultCharacter/skeleton.json";
    ...
    public void receiveEditCards() {
        ...
        new AutoAdd("LastLightMod") // ${project.artifactId}
